...
<ul class="nav nav-pills nav-stacked">
	...
	<li  class="active"><a href="records">交易记录</a></li>
...
<tr><td style="width: 20%;"><input  id="itcode" name="itcode" type="text" class="form-control" placeholder="输入员工号"></td>
	<td style="width: 20%;"><input id="username" name="username" type="text" class="form-control" placeholder="输入姓名"></td>
	...
	<td colspan="2" style="width: 35%" align="center"><div class="input-group" >
	<select class="form-control" name="memo"> <option>所有</option> 
      <option>充值</option> 
      <option>打赏</option>
      <option>红包雨</option> 
      <option>抢红包</option> 
...
<tr align="center" style="color: white;"><td>员工号</td><td>姓名</td><td>交易金额(元)</td><td>交易时间</td><td>备注</td></tr>
<c:forEach items="${trades }" var="trade">
<tr align="center"><td>${trade.itcode }</td><td>${trade.username }</td><td>${trade.amount }</td><td>${trade.tradetime }</td><td>${trade.memo }</td></tr>
</c:forEach>
</table>
</form>
</div>
